...
export const AboutUs = () => {
 ...
 <div className="w-full md:w-5/12 lg:w-1/2">
        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
          ...
          <br />
          <Paragraph>
            AutoPyReq solves one of the biggest headaches for Python developers — managing dependencies when <code>requirements.txt</code> is missing or outdated. We use smart code parsing and AI verification to generate a clean, accurate dependency list with ease.
          </Paragraph>
